...
[assembly: SuppressMessage("Microsoft.Design", "CA1020:AvoidNamespacesWithFewTypes", Scope = "namespace", Target = "IdentityModel.HttpSigning.Logging")]
[assembly: SuppressMessage("Microsoft.Design", "CA1026:DefaultParametersShouldNotBeUsed", Scope = "member", Target = "IdentityModel.HttpSigning.Logging.Logger.#Invoke(IdentityModel.HttpSigning.Logging.LogLevel,System.Func`1<System.String>,System.Exception,System.Object[])")]

// If you copied this file manually, you need to change all "YourRootNameSpace" so not to clash with other libraries
// that use LibLog
#if LIBLOG_PROVIDERS_ONLY
namespace IdentityModel.HttpSigning.LibLog
#else
namespace IdentityModel.HttpSigning.Logging
#endif
{
    using System.Collections.Generic;
    using System.Diagnostics.CodeAnalysis;
#if LIBLOG_PROVIDERS_ONLY
    using IdentityModel.HttpSigning.LibLog.LogProviders;
#else
    using IdentityModel.HttpSigning.Logging.LogProviders;
#endif
    using System;
#if !LIBLOG_PROVIDERS_ONLY
    ...
    static class LogProvider
    {
        ...
        /// will be disabled.
        /// </summary>
        public const string DisableLoggingEnvironmentVariable = "IdentityModel.HttpSigning_LIBLOG_DISABLE";
...
#if LIBLOG_PROVIDERS_ONLY
namespace IdentityModel.HttpSigning.LibLog.LogProviders
#else
namespace IdentityModel.HttpSigning.Logging.LogProviders
#endif
{
    using System;
    using System.Collections.Generic;
